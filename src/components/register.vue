<template>
  <div
    class="d-flex justify-content-center align-items-center vh-150 bg-light mb-3"
  >
    <div class="card p-4 shadow-lg rounded" style="width: 700px">
      <h3 class="text-center mb-2">Đăng Kí</h3>
      <form @submit.prevent="guiForm">
        <!-- Họ và Tên -->
        <div class="mb-3">
...
const guiForm = () => {
  axios
    .post("http://localhost:8080/register", data.value, {
      headers: {
